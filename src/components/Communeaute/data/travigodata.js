...
export const hero = {
  "title": "Coder, c'est entre dans un autre univers",
  "subtitle": "Alors, Vas Explorer",
  "text": "Code avec passion, rêve en pixels, crée l'avenir numérique.Embrasse le défi, explore sans peur, deviens un créateur.",
  "btn1": "S'exercer",
  "img": dashboard,
};

export const memory = {
  "title": "Rejoins les communautés",
  "subtitle": "grandis ensemble brillamment",
...
export const placesAPI = [
  { "placeImg": place1, "location": "ENIDance", "distance": "3.0 hour dirve" },
  { "placeImg": place2, "location": "ENI Hoopers", "distance": "2.5 hour dirve" },

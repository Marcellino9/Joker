        ...
        >
          ...
          <div className="hidden sm:block">
            <div className="font-semibold">
              <p className="text-gray-500 ">Tanambao</p>
              <p className="text-sm text-green-800">Fianarantsoa</p>
            </div>
            <div className="font-semibold">
          ...
          <div className="flex justify-center sm:justify-end mb-4">
            <div className="flex flex-row sm:flex-col  gap-5">
              <div className="bg-white rounded-full p-2 shadow-md hover:scale-110 duration-200">
                <IoIosArrowBack className="text-green-800" />
              </div>
              <div className="bg-green-800 rounded-full p-2 shadow-md hover:scale-110 duration-200">
